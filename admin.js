...
function renderTicketItem(t, index, prefix) {
  ...
  // Stockage des données du ticket en JSON dans un attribut de données
  ...
  return `
    <div class="ticket-wrapper ${isCanc ? 'is-cancelled' : ''}" 
      ...
      <!-- Rangée simplifiée : Seulement Code, Date, Total, Statut -->
      <div class="ticket-row" onclick="openTicketModal('${ticketDataJson}')">
...
// Fonction pour ouvrir la fenêtre indépendante (Modal)
function openTicketModal(jsonString) {
  ...
  const oldModal = document.getElementById('ticket-modal-overlay');
  if (oldModal) oldModal.remove();

  // Injecte la nouvelle modal
  document.body.insertAdjacentHTML('beforeend', modalHTML);
}

// Fonction pour fermer la fenêtre indépendante
